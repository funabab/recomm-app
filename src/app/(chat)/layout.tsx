      ...
      <body className="h-full overscroll-contain">
        <main className="flex flex-col h-full">
          <header className="shrink-0 bg-base-300 pt-[7px] pb-[6px] justify-center items-center flex gap-x-[21px] px-5 border-b border-b-neutral-content">
            ...
            <Link
              href="/chat/1234/profile/1234"
              className="avatar placeholder online [&.online:before]:!bg-[#56A97A] [&.offline:before]:!bg-[#a95656] [&:before]:!top-[unset] [&:before]:bottom-px [&:before]:!-right-px cursor-pointer ml-auto"
            >
