...
import { editDepartmentDetails } from '@/app/_actions/department'
...
export interface EditDepartmentModalRef {
  showModal: () => void
}
...
export default React.forwardRef<EditDepartmentModalRef, Props>(
  function EditDepartmentModal({ dialogTrigger, ...props }, ref) {
            ...
            <form
              ...
              action={(formdata) => {
                startTransition(async () => {
                  const { message } = await editDepartmentDetails(formdata)
