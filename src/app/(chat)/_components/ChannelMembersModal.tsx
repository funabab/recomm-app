...
export default React.forwardRef<ChannelMembersModalRef, Props>(
  function ChannelMembersModal(props: Props, ref) {
    ...
    const addMemberToChannelModalRef =
      React.useRef<AddMemberToChannelModalRef>(null)
    ...
    return (
      <React.Fragment>
        ...
        <AddMemberToChannelModal ref={addMemberToChannelModalRef} />
      </React.Fragment>
    )
  }
)
