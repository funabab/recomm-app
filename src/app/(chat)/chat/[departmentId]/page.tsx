  ...
  return (
    <div className="w-full h-full justify-center items-center font-lato flex flex-col gap-y-2">
      ...
      >
        ...
        <path
          fill="#f0f0f0"
          d="M34.721 154.426h141.856v4.305H34.721zM34.721 169.318h247.243v4.305H34.721zM34.721 184.21h247.001v4.305H34.721zM524.031 351.07s1.487-31.16 31.972-27.538"
        />
        ...
        <path
          fill="#fff"
          d="M589.307 189.97a32.627 32.627 0 0 1 50.08 0 36.264 36.264 0 1 0-51.27-1.189q.58.609 1.19 1.19ZM687.219 189.97a32.627 32.627 0 0 1 50.08 0 36.264 36.264 0 1 0-51.27-1.189q.58.609 1.19 1.19Z"
        />
        <circle cx={601.976} cy={151.392} r={12.474} fill="#3f3d56" />
        <circle cx={699.885} cy={151.392} r={12.474} fill="#3f3d56" />
        <circle cx={578.083} cy={210.898} r={14.505} fill="#00bfa6" />
        <circle cx={744.896} cy={210.898} r={14.505} fill="#00bfa6" />
        <path
          fill="#00bfa6"
          d="m661.49 181.886-10.879 47.143 18.131-18.131-7.252-29.012z"
        />
        <path
          fill="#3f3d56"
        ...
        <path
          fill="#00bfa6"
          d="M102.459 48.916h204.737v6.213H102.459zM102.459 70.41h356.84v6.213h-356.84zM102.459 91.903h356.49v6.213h-356.49z"
        />
        <path
          fill="#cacaca"
          d="M862.917 364.205h-381a1 1 0 0 1 0-2h381a1 1 0 0 1 0 2Z"
        />
      </svg>
